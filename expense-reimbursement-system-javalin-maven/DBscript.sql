...
create view employee_table as select employees.emp_id, employees.first_name, employees.last_name, employees.user_name, employees.hashed_password, roles.role_id, roles.role from employees inner join roles on employees.emp_role_id=roles.role_id;
